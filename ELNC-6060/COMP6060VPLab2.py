...
itemname = input("please enter the item name to be purched : ") # Procedure -3
...
print("Your quantity item(s) at $",itemPrice,"each will cost $",totalPrice) # Procedure -12

# Procedure -13 \\ print the total weight of the item
print("Your quantity item(s) at ",itemAvgWeight,"lbs each will weigh ",totalweighht,"lbs") # Procedure -13